  ...
  return (
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: '"Inter", system-ui, sans-serif' }}>
      ...
      <div className="pro-auth-card">
        <h2 className="pro-auth-title">Welcome Back</h2>
        <p className="pro-auth-subtitle">Log in to your account to continue</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="pro-submit-btn">Sign In</button>
        </form>
        <p className="pro-auth-footer">
          Don't have an account? <Link to="/signup" className="pro-auth-link">Create one</Link>
        </p>
      </div>
    </div>
  );
